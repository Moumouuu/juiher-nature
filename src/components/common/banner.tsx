...
export const Banner = ({ title }: BannerProps) => {
  return (
    <div
      className={
        "relative w-full lg:h-[50vh] flex flex-col items-center justify-center py-20 lg:py-10 bg-juiher-ternary-green"
      }
    >
      {title}
      <p className={"my-2 text-center"}>
        Juiher nature vous permet de révéler la beauté naturelle de votre
        environnement grâce à notre expertise en élagage.
      </p>
      <ul className={"flex flex-wrap justify-center my-4 lg:my-0"}>
        ...
        <li className={"list-disc mx-4"}>Réseaux routiers et autoroutiers</li>
      </ul>
