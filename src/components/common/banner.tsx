...
export const Banner = ({title} : BannerProps ) => {
    return (
        <div className={"relative w-full h-[50vh] flex flex-col items-center justify-center py-10 bg-juiher-ternary-green"}>
            <h1 className={'text-5xl uppercase font-semibold leading-relaxed'}>
                {title}
            </h1>
            <p className={"my-2"}>Juiher nature vous permet de révéler la beauté naturelle de votre environnement grâce
            ...
            <Button className={"mt-3"} variant={"juiher"} asChild>
                <Link href={"/#contact"}>
                    Contactez-nous
                </Link>
            </Button>
